...
export class AuthService {
  ...
  signup(email: string, password: string) {
    return this.http
      .post<AuthResponseData>(
        'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCGYD0Cg4kFvL5HkP96sYkd9uNBcEwaWrA',
        {
          email: email,
          password: password,
  ...
  login(email: string, password: string) {
    return this.http
      .post<AuthResponseData>(
        'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCGYD0Cg4kFvL5HkP96sYkd9uNBcEwaWrA',
        {
          email: email,
          password: password,
          returnSecureToken: true,
  ...
  logout() {
    ...
    if(this.expDurationTimer) clearTimeout(this.expDurationTimer);
